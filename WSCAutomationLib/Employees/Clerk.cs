...
namespace WSCAutomation.Employees
{
	public sealed class Clerk : Employee
	{
        ...
        {
            SendNotification("wscspec60683@gmail.com", this.Email, "Inventory Ordered", "The inventory that you requested that was not in stock has been ordered. Delievery expected: [DATE]");
